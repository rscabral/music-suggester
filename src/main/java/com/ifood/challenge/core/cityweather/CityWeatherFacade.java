...
public class CityWeatherFacade {
  ...
  public CityWeatherDto getCityWeatherByCityName(String cityName) throws CityWeatherNotFound {
    return repository.findByCityName(cityName).orElseThrow(CityWeatherNotFound::new);
  }

  public CityWeatherDto getCityWeatherByCityCoordinates(Double latitude,
